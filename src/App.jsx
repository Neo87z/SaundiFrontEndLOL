  ...
  return (
    <>
      <Routes>
        ...
        <Route path="/scoliosis-detection" element={<GetCitationTopic />} />
        <Route path="/angel-det" element={<CitationHome />} />
        ...
        <Route path="/precautions" element={<Pricing />} />
        <Route path="/speech-evaluvate" element={<SpeechEvalucate />} />
        <Route path="/treatments" element={<Blog />} />
        <Route path="/treatmenssts" element={<BlogPost />} />
        <Route path="/meet-our-doctors" element={<About />} />
