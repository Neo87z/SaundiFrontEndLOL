        ...
        <div className="pt-10 pb-12 md:pt-16 md:pb-20">
          ...
          <div className="max-w-sm mx-auto grid gap-8 md:grid-cols-4 lg:gap-16 items-start md:max-w-none">
            ...
            <div className="relative flex flex-col items-center" data-aos="fade-up">
              ...
              <h4 style={{color:'black'}}className="h4 mb-2"> Meet Our Doctors</h4>
              <p style={{color:'black'}} className="text-lg text-gray-400 text-center">We have a wide range of experienced doctors to help the patients which specalizes in many types of Scoliosis</p>
            </div>
            ...
            <div className="relative flex flex-col items-center" data-aos="fade-up" data-aos-delay="200">
              ...
              <h4 style={{color:'black'}} className="h4 mb-2"> Scoliosis Detection </h4>
              <p style={{color:'black'}} className="text-lg text-gray-400 text-center">Smart Health APP Provides a tool a tool which allows the patients to detect Scoliosis on thier own</p>
            </div>
            <div className="relative flex flex-col items-center" data-aos="fade-up" data-aos-delay="200">
              <div aria-hidden="true" className="absolute h-1 border-t border-dashed border-gray-700 hidden md:block" style={{ width: 'calc(100% - 32px)', left: 'calc(50% + 48px)', top: '32px' }} data-aos="fade-in" data-aos-delay="400"></div>
              <svg className="w-16 h-16 mb-4" viewBox="0 0 64 64" xmlns="http://www.w3.org/2000/svg">
              ...
              <h4 style={{color:'black'}} className="h4 mb-2"> Treatments</h4>
              <p style={{color:'black'}} className="text-lg text-gray-400 text-center">With the help of our experienced doctors we have made catalouge of many Treatments which will help of the patienst with Scoliosis.</p>
            </div>
            ...
            <div className="relative flex flex-col items-center" data-aos="fade-up" data-aos-delay="400">
              ...
              <h4 style={{color:'black'}}  className="h4 mb-2">Precuations</h4>
              <p style={{color:'black'}} className="text-lg text-gray-400 text-center">Prevetion is always better than a cure!. Our experienced doctors have made list of important precautions to prevent Scoliosis</p>
            </div>
